...
config0 = OpenCVCameraConfig(
    index_or_path='/dev/v4l/by-id/usb-Sonix_Technology_Co.__Ltd._USB2.0_CAM1_USB2.0_CAM1-video-index0', # type: ignore
    fps=30,
    width=640,
    height=480,
...
config1 = OpenCVCameraConfig(
    index_or_path='/dev/v4l/by-id/usb-046d_Logitech_BRIO_8F54E371-video-index0', # type: ignore
    fps=30,
    width=640,
    height=480,
    color_mode=ColorMode.RGB,
...
def draw_fps_graph(history, width=400, height=200, max_fps=60):
    ...
    # Add labels
    cv2.putText(graph, "FPS Graph", (10, 20),
